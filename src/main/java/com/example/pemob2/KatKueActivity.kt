...
class KatKueActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kat_kue)
        ...
        // Get reference for greeting TextView
        ...
        // Set item click listener for each recipe item
    ...
    /**
     * Fetch user name from Realtime Database as a fallback
     */
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    for (data in snapshot.children) {
                        ...
                        recipe?.let {
                            val ingredientsList = it.bahanResep.split(",")  // Assuming ingredients are separated by commas
                    ...
                    Toast.makeText(this@KatKueActivity, "Resep Tidak Ditemukan", Toast.LENGTH_SHORT).show()
                }
            }

            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@KatKueActivity, "Gagal Memuat Resep", Toast.LENGTH_SHORT).show()
            }
        })
    }
}
