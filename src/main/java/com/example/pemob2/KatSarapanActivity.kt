...
class KatSarapanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kat_sarapan)
    ...
    private fun fetchFromRealtimeDatabase(greetingTextView: TextView, userId: String) {
        ...
        userRef.get()
            ...
            .addOnFailureListener { exception ->
                Toast.makeText(this@KatSarapanActivity, "Gagal Mengambil Data Pengguna", Toast.LENGTH_SHORT).show()
                greetingTextView.text = "Halo, Pengguna"
            }
    }
        ...
        recipesRef.orderByChild("kategori").equalTo(category).addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(this@KatSarapanActivity, "Resep Tidak Ditemukan", Toast.LENGTH_SHORT).show()
                }
            }

            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@KatSarapanActivity, "Gagal Memuat Resep", Toast.LENGTH_SHORT).show()
            }
        })
    }
}
