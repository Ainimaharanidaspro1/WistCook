...
class KatNusantaraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kat_nusantara)
        ...
        recipesRef.orderByChild("kategori").equalTo(category).addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(this@KatNusantaraActivity, "Resep Tidak Ditemukan", Toast.LENGTH_SHORT).show()
                }
            }

            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@KatNusantaraActivity, "Gagal Memuat Resep", Toast.LENGTH_SHORT).show()
            }
        })
    }
}
